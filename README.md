...
Secara teknis, Cermatify adalah aplikasi mobile berbasis Flutter yang menggunakan Node.js sebagai backend, Google Cloud sebagai infrastruktur server, dan PostgreSQL sebagai database. Flutter digunakan untuk membangun antarmuka aplikasi di sisi pengguna, sedangkan backend bertugas mengelola proses bisnis seperti login, pemilihan layanan, pencocokan mentor, transaksi, dan evaluasi layanan. Data pengguna, mentor, layanan, dan transaksi disimpan secara terstruktur di PostgreSQL, sementara keamanan data didukung dengan SSL/TLS.
