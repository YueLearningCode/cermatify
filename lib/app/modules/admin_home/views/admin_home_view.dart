...
class AdminHomeView extends GetView<AdminHomeController> {
  ...
  Widget build(BuildContext context) {
    ...
    final int statColumns = isDesktop ? 4 : 2;
    final int actionColumns = isDesktop ? 4 : (isTablet ? 3 : 2);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GridView.count(
                          ...
                          mainAxisSpacing: 12,
                          crossAxisSpacing: 12,
                          childAspectRatio: isDesktop ? 1.75 : 1.25,
                          ...
                          children: [
                            ...
                            _buildStatCard(
                              title: "Master Data",
                              value: controller.totalMasterData.value
                                  .toString(),
