            ...
            return SingleChildScrollView(
              ...
              child: Center(
                child: ConstrainedBox(
                  constraints: BoxConstraints(maxWidth: isDesktop ? 760 : 450),
                  child: Form(
                        ...
                        Obx(
                          () => Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color:
                                    controller.selectedKampus.value.isNotEmpty
                        ...
                        Obx(
                          () => Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color:
                                    controller.selectedJurusan.value.isNotEmpty
                                    ? AppColors.secondaryColor
                                    : Colors.grey,
                                width: 1.0,
                              ),
                            ...
                            child: DropdownButtonFormField<String>(
                              value: controller.selectedJurusan.value.isEmpty
                                  ? null
