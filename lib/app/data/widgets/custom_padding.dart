...
/// [CustomPadding] adalah widget kustom yang menyediakan pilihan padding yang sudah diatur
class LeftAlignedColumn extends StatelessWidget {
  final List<Widget> children;

  const LeftAlignedColumn({super.key, required this.children});
...
class CenterAlignedColumn extends StatelessWidget {
  ...
  const CenterAlignedColumn({super.key, required this.children});
...
class RightAlignedColumn extends StatelessWidget {
  ...
  const RightAlignedColumn({super.key, required this.children});
...
class LeftAlignedRow extends StatelessWidget {
  ...
  const LeftAlignedRow({super.key, required this.children});
...
class RightAlignedRow extends StatelessWidget {
  ...
  const RightAlignedRow({super.key, required this.children});
...
extension PaddedWidget on Widget {
  Widget topPadded4([final value = const EdgeInsets.only(top: 4)]) =>
      Padding(padding: value, child: this);
  Widget topPadded12([final value = const EdgeInsets.only(top: 12)]) =>
      Padding(padding: value, child: this);

  Widget topPadded16([final value = const EdgeInsets.only(top: 16)]) =>
      Padding(padding: value, child: this);

  Widget topPadded20([final value = const EdgeInsets.only(top: 20)]) =>
      Padding(padding: value, child: this);

  Widget topPadded30([final value = const EdgeInsets.only(top: 30)]) =>
      Padding(padding: value, child: this);
  ...
  Widget padded16([final value = const EdgeInsets.all(16)]) =>
      Padding(padding: value, child: this);
  ...
  Widget withoutTopPadded16([
    final value = const EdgeInsets.only(bottom: 16, left: 16, right: 16),
  ]) => Padding(padding: value, child: this);

  Widget padded8([final value = const EdgeInsets.all(8)]) =>
      Padding(padding: value, child: this);
  ...
  Widget leftPadded8([final value = const EdgeInsets.only(left: 8)]) =>
      Padding(padding: value, child: this);

  Widget leftPadded4([final value = const EdgeInsets.only(left: 4)]) =>
      Padding(padding: value, child: this);
  ...
  Widget padded([final value = 16]) =>
      Padding(padding: EdgeInsets.all(value.toDouble()), child: this);
