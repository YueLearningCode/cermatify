...
class AdminBottomNavbar extends StatelessWidget {
      ...
      child: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            ...
            _buildNavBarItem(Icons.storage_outlined, Icons.storage, "Master Data", 2),
            _buildNavBarItem(Icons.person_outlined, Icons.person, "Profile", 3),
          ],
        ),
      ),
    );
  ...
  BottomNavigationBarItem _buildNavBarItem(IconData outlinedIcon, IconData filledIcon, String label, int index) {
