  ...
  Kuesioner(
    ...
    answers: [
      QuestionAnswer(
        ...
        answer:
            'Sangat baik, platform ini sangat membantu dalam proses belajar saya.',
      ),
      QuestionAnswer(
        question: 'Apakah fitur yang tersedia sudah memenuhi kebutuhan Anda?',
        answer:
            'Ya, fitur-fitur yang ada sudah cukup lengkap untuk kebutuhan saya.',
      ),
      QuestionAnswer(
        question: 'Bagaimana tingkat kepuasan Anda dengan layanan mentor?',
        answer:
            'Sangat puas, mentor memberikan bimbingan yang sangat membantu.',
      ),
    ],
  ),
  Kuesioner(
    ...
    answers: [
      QuestionAnswer(
        ...
        answer:
            'Saya menggunakan platform ini hampir setiap hari untuk belajar.',
      ),
      QuestionAnswer(
        question: 'Fitur apa yang paling sering Anda gunakan?',
        answer:
            'Saya paling sering menggunakan fitur Cermat Paper untuk bimbingan penulisan paper.',
      ),
      QuestionAnswer(
        question: 'Apakah ada saran untuk pengembangan platform?',
        answer:
            'Mungkin bisa ditambahkan fitur notifikasi untuk reminder jadwal bimbingan.',
      ),
    ],
  ),
  Kuesioner(
    ...
    answers: [
      ...
      QuestionAnswer(
        question:
            'Apakah Anda akan merekomendasikan platform ini kepada teman?',
